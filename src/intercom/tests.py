...
class MemberModelTest (TestCase):
    ...
    def test_access_checks_work(self):
        ...
        r1 = models.TimeRule.objects.create(membership=mt_dummy, day='*', is_open=True, priority=1)
        r2 = models.TimeRule.objects.create(membership=mt_dummy, day='mf', is_open=True, priority=1)
        r3 = models.TimeRule.objects.create(membership=mt_dummy, day='mf', is_open=True, closing_time=datetime.time(18, 0, 0), priority=1)
        r4 = models.TimeRule.objects.create(membership=mt_dummy, day='0', is_open=True, closing_time=datetime.time(20, 0, 0), priority=1)
        r5 = models.TimeRule.objects.create(membership=mt_dummy, day='0', is_open=True, closing_time=datetime.time(18, 0, 0), priority=1)
        r6 = models.TimeRule.objects.create(membership=mt_dummy, day='1', is_open=True, closing_time=datetime.time(20, 0, 0), priority=1)
        r7 = models.TimeRule.objects.create(membership=mt_dummy, day='0', is_open=False, priority=0)
        r8 = models.TimeRule.objects.create(membership=mt_dummy, day='1', is_open=False, priority=0)
        r9 = models.TimeRule.objects.create(membership=mt_dummy, day='0', is_open=False, closing_time=datetime.time(20, 0, 0), priority=0)
        r10 = models.TimeRule.objects.create(membership=mt_dummy, day='0', is_open=False, closing_time=datetime.time(18, 0, 0), priority=0)
        r11 = models.TimeRule.objects.create(membership=mt_dummy, day='0', is_open=False, priority=2)
        ...
        # Open every day, all day (higher priority than Monday closing)
        r1.membership = mt; r1.save()
        r11.membership = mt; r11.save()
        self.assert_(m.is_allowed_access(dt))
        r1.membership = mt_dummy; r1.save()
        r11.membership = mt_dummy; r11.save()
